...
export default Object.extend({
  ...
  // This param is used to decide, which relationships of which type
  // shall be included in getItemWithInclude
  ...
  saveRelationships(object) {
    ...
    const keys = Object.keys(this.relationshipsToBeSaved);
  ...
  getItemWithInclude: function (id) {
    var { relationshipsToInclude } = this;
    var result = this.getItem(id);
    if (!result) {
      return undefined;
    }
    var { relationships } = result.data;
    var included = [];

    const types = Object.keys(this.relationshipsToInclude);
